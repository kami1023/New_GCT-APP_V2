            ...
            <div className="flex flex-col md:flex-row justify-between items-end gap-6">
              <div className="relative w-full md:w-96">
                <input 
                  ...
                  className="glass-input w-full pl-12 pr-12 text-sm h-[56px]"
                  value={searchQuery}
              ...
              <div className="glass-panel p-20 flex flex-col items-center justify-center text-center space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-zinc-500 max-w-sm">
                    We couldn't find any products matching <span className="text-sky-400 font-mono font-bold">"{searchQuery}"</span>
                  </p>
                </div>
                <button
                  onClick={() => {
                  ...
                  className="px-8 py-3 glass-card text-xs font-black uppercase tracking-widest hover:text-white transition-colors"
                >
                  Clear Search
                </button>
              </div>
