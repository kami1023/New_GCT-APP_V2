          ...
          <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
              ...
              <div className="relative w-full md:w-96">
                ...
                {searchQuery && (
                  <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 p-1 hover:bg-white/10 rounded-sm transition-colors text-zinc-500 hover:text-white"
            ...
            {filteredProducts.length === 0 ? (
              <div className="glass-panel p-20 flex flex-col items-center justify-center text-center space-y-6">
                <div className="w-20 h-20 bg-zinc-500/10 rounded-full flex items-center justify-center border border-white/5">
                  <Search className="w-10 h-10 text-zinc-600" />
                </div>
                <div className="space-y-2">
                  <h3 className="text-xl font-black text-white uppercase tracking-tighter">No products found</h3>
                  <p className="text-zinc-500 text-sm max-w-xs">We couldn't find any products matching "{searchQuery}". Try a different term or clear the search.</p>
                </div>
                <button
                  onClick={() => {
                    setSearchQuery('');
                  ...
                  className="px-8 py-3 glass-card text-sky-400 text-[10px] font-black uppercase tracking-widest hover:bg-sky-500/10 transition-all"
                >
                  Clear Search
                </button>
              </div>
