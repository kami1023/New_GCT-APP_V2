          ...
          <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            {filteredProducts.length > 0 ? (
              ...
              <div className="glass-panel p-20 flex flex-col items-center justify-center text-center animate-in fade-in zoom-in-95 duration-500">
                ...
                <p className="text-zinc-500 max-w-xs mb-8">We couldn't find any products matching "{searchQuery}". Try a different search term or clear the filter.</p>
                <button
                  onClick={() => {
                    setSearchQuery('');
                    searchInputRef.current?.focus();
                  }}
                  className="px-8 py-4 glass-card text-[10px] font-black uppercase tracking-[0.2em] text-sky-400 hover:text-white transition-all"
                >
                  Clear Search
                </button>
              </div>
