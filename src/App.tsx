              ...
              <div className="relative w-full md:w-96">
                ...
                {searchQuery && (
                  <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 p-1 hover:bg-white/10 rounded-sm text-zinc-500 hover:text-white transition-colors"
            ...
            {filteredProducts.length > 0 ? (
              ...
              <div className="glass-panel py-20 flex flex-col items-center justify-center text-center animate-in fade-in zoom-in-95 duration-500">
                ...
                <button
                  ...
                  className="px-6 py-2 glass-card text-[10px] font-black uppercase tracking-widest text-sky-400 hover:text-sky-300 transition-all"
                >
