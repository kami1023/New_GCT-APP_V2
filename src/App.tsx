          ...
          <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            {products.filter(p =>
              ...
              <div className="glass-panel p-20 flex flex-col items-center justify-center text-center animate-in fade-in zoom-in-95 duration-500">
                ...
                <h3 className="text-xl font-black text-white uppercase tracking-tight mb-2">No matching products</h3>
                <p className="text-zinc-500 text-sm max-w-xs mb-8">We couldn't find any products matching "{searchQuery}". Try a different term or clear the search.</p>
                <button
                  onClick={() => {
                    setSearchQuery('');
                    searchInputRef.current?.focus();
