          ...
          <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            {filteredProducts.length > 0 ? (
              ...
              <div className="glass-panel py-24 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-zinc-500 text-sm mb-8">Try adjusting your search terms or clear the search.</p>
                <button
                  onClick={() => {
                    setSearchQuery('');
                    searchInputRef.current?.focus();
                  }}
                  className="px-8 py-3 glass-card text-[10px] font-black uppercase tracking-widest text-sky-400 hover:bg-sky-500/10"
                >
                  Clear Search
                </button>
              </div>
