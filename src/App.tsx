          ...
          <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            {filteredProducts.length > 0 ? (
              ...
              <div className="glass-panel p-20 flex flex-col items-center text-center">
                ...
                <p className="text-zinc-500 max-w-sm mb-8">We couldn't find any products matching "{searchQuery}". Try a different search term or clear the search.</p>
                <button
                  onClick={() => {
                    setSearchQuery('');
                    searchInputRef.current?.focus();
                  }}
                  className="px-8 py-4 glass-card text-sky-400 font-black uppercase tracking-widest text-[10px] hover:bg-sky-500/10 transition-all"
                >
                  Clear Search
                </button>
              </div>
