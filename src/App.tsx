          ...
          <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
              ...
              <div className="relative w-full md:w-96">
                ...
                {searchQuery && (
                  <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 p-1 hover:bg-white/10 rounded-sm transition-colors"
            ...
            {filteredProducts.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-20 glass-panel border-dashed border-2 border-white/5">
                ...
                <p className="text-zinc-500 mb-8">No results match "{searchQuery}"</p>
                <button
                  onClick={() => setSearchQuery('')}
                  className="px-6 py-2 glass-panel text-sky-400 text-xs font-black uppercase tracking-widest hover:bg-sky-500/10 transition-all"
                >
                  Clear Search
                </button>
              </div>
