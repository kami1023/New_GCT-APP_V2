        ...
        {activeTab === 'dashboard' && (
          <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            {filteredProducts.length > 0 ? (
              ...
              <div className="glass-panel p-20 flex flex-col items-center justify-center text-center space-y-4 w-full">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-zinc-500 text-sm">We couldn't find any products matching "{searchQuery}"</p>
                </div>
                <button
                  onClick={() => {
                    setSearchQuery('');
                  ...
                  className="px-6 py-3 glass-card text-[10px] font-black uppercase tracking-widest text-sky-400 hover:text-white transition-all"
                >
                  Clear Search
                </button>
              </div>
